...
import logos from "../assets/tech-logos.jpeg";
      ...
      <div className="about-container">
        ...
        <div className="text-sections">
          <p className="presentation">
            ...
            casualidad, descubrí el mundo del <strong>desarrollo web</strong>… y todo cambió. La
            ...
            lleno a formarme como <strong>Desarrolladora Web.</strong> No fue una decisión fácil,
            ...
            conocimientos en <strong>tecnologías cloud con AWS</strong>, lo cual me ha dado una
